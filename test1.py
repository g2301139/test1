...
# 右上：いまの天気一覧
summary_html = """
<div style="position: fixed; top: 15px; right: 15px; z-index: 999999; background-color: white; border: 3px solid #333; padding: 10px; border-radius: 10px; box-shadow: 4px 4px 10px rgba(0,0,0,0.5); width: 220px; max-height: 50vh; overflow-y: auto; font-family: sans-serif;">
